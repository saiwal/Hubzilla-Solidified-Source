...
//
// Alternate archive layout: every year is always visible with a compact
// 4-column month grid, instead of the accordion list in ArchiveWidget.
                ...
                return (
                  <div>
                    <div class="flex items-baseline justify-between px-1 mb-1.5">
                      <span class="text-sm font-medium text-txt">{yr.year}</span>
                      <span class="text-xs text-muted">{yr.count}</span>
                    </div>
                    <div class="grid grid-cols-4 gap-1">
