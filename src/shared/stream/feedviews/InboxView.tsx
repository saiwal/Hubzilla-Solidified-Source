  ...
  return (
    <div class="border-t border-rim bg-overlay px-4 py-3">
          ...
          {(msg) => (
            <div class="flex gap-3">
              <Show
                ...
                fallback={
                  <div
                    class="w-7 h-7 rounded-full bg-gradient-to-br from-accent to-accent-txt
      ...
      <Show when={props.thread.iid}>
        <div class="pt-3 border-t border-rim mt-3">
          <CommentComposer
    ...
    <div class="border-b border-rim last:border-0">
      ...
      >
            ...
            {(name) => {
              ...
              return (
                <Show
                  ...
                  fallback={
                    <div
                      class="w-6 h-6 rounded-full ring-2 ring-surface bg-gradient-to-br from-accent to-accent-txt
        ...
        <Show when={replyCount > 0}>
          <span class="shrink-0 text-[11px] bg-accent-muted text-muted rounded-full px-2 py-0.5">
            {replyCount}
          </span>
        </Show>

        <span
          class="text-[11px] text-muted w-14 text-right shrink-0"
