...
const PostComposer: Component<ComposerProps> = (props) => {
  ...
  function onKey(e: KeyboardEvent) {
    // Mention popup gets first crack at arrow/enter/tab/escape
    if (mention.onKeyDown(e)) {
      // Enter/Tab: confirm the highlighted entry
      if (e.key === "Enter" || e.key === "Tab") {
        ...
        if (entry) {
          if (tab() === "wysiwyg") {
            ...
            mention.insertTextarea(entry, textareaRef, setBody);
          }
        }
      }
      return;
            ...
            <div class="flex flex-col flex-1 overflow-hidden min-h-0">
              ...
              <textarea
                ...
                onInput={(e) => {
                  ...
                  // Drive mention autocomplete for source tab
                  mention.onTextareaInput(e.currentTarget);
                }}
                spellcheck={false}
              />
            </div>
