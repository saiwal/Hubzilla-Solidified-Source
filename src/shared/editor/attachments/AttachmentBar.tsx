  ...
  return (
    ...
    >
      ...
      <div class="flex items-center gap-2 px-3 py-2">
        ...
        <button
          type="button"
          title="Browse existing files and photos"
        ...
        {/* Drag hint */}
        <Show when={dragging()}>
          <span class="text-xs text-accent ml-1">Drop files here</span>
        </Show>

        {/* Upload in-progress indicator */}
        <Show when={props.store.uploading()}>
          <span class="text-xs text-muted ml-auto animate-pulse">Uploading…</span>
        </Show>
      </div>
