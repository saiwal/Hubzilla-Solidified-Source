      ...
      >
        ...
        <div class="relative">
          ...
          >
            <div
              ref={bodyRef}
              class="post-body text-sm text-muted leading-relaxed
            ...
            >
              <button
                class="flex items-center gap-1 text-xs text-accent
                       hover:text-accent-txt
                       bg-overlay/90 px-2 py-0.5 rounded-full
        ...
        <Show when={overflows() && expanded()}>
          <button
            class="flex items-center justify-center gap-1 text-xs text-accent
                   hover:text-accent-txt mt-1 w-full transition-colors"
            onClick={(e) => {
              e.stopPropagation();
              setExpanded(false);
            }}
