// src/modules/network/views/feedviews/ListView.tsx
    ...
    <>
      ...
      >
        ...
        <Show
          ...
          fallback={
            <div
              class="w-6 h-6 rounded-full bg-gradient-to-br from-blue-400 to-indigo-500
        ...
        >
          <button
            onClick={(e) => { e.stopPropagation(); handleLike(p.mid); }}
          ...
          <button
            onClick={(e) => { e.stopPropagation(); handleRepeat(p.mid); }}
            class="flex items-center gap-0.5 text-[11px] transition-colors"
            classList={{
        ...
        {/* Date */}
        <span
          class="text-[11px] text-gray-400 shrink-0 w-16 text-right"
...
export default function ListView(props: { posts: ThreadNode[] }) {
  return (
    <div
      class="bg-surface rounded-xl border border-gray-100 dark:border-gray-700/50
              shadow-sm overflow-hidden"
    >
      <div
        class="flex items-center gap-3 px-4 py-2 border-b border-gray-100 dark:border-gray-700
